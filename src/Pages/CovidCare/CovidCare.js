        ...
        <section className="container my-5" >
            <div className="row d-flex align-items-center">
                <div className="col-12 col-lg-6 ">
                    <h4 className="h3-color">COVID-19 ALERT</h4>
                     <h2 className="h1-color my-lg-3">Stay at Home quarantine To stop Corona virus
                    </h2>
    ...
    <main>
        ...
        <section className="container" id="Overview">
            <div className="row my-5 d-flex align-items-center">
                ...
                <div className="col-12 col-lg-6">
                    <h4 className="h3-color">What is Covid-19
                    </h4>
                    <h2 className="h1-color mb-lg-5">Coronavirus</h2>
                ...
                <a href="https://www.who.int/emergencies/diseases/novel-coronavirus-2019" target="blank"><button className="btn btn-color text-white rounded-pill">LEARN MORE</button></a>
        ...
        <section className="container text-center my-5" id="Contagion">
            ...
            <h2 className="h1-color mb-lg-5">Contagion
            </h2>
            ...
            <div className="row row-cols-1 row-cols-md-3 g-4 border-0 my-5">
                <div className="col">
                  <div className="card h-100 border-0 shadow-lg p-2">
                    <img src={p3} class="card-img-top" alt="..."/>
                  
                    <div className="card-body">
                      <h4 className="card-title text-danger fw-bold mt-3">Air Transmission
                    </h4>
                      <p className="card-text py-3">Objectively evolve tactical expertise before extensible initiatives. Efficiently simplify
                    </p>
                    </div>
                    <div className="">
                ...
                <div className="col">
                  <div className="card h-100 border-0 shadow-lg p-2">
                    ...
                    <div className="card-body">
                      <h4 className="card-title text-danger fw-bold mt-3">Human Contacts
                    </h4>
                      <p className="card-text py-3">Washing your hands is one of thesimplest ways you can protect
                    </p>
                    </div>
                    <div className="">
                       <button className="btn btn-danger w-100">Learn more</button>
                ...
                <div className="col">
                  <div className="card h-100 border-0 shadow-lg p-2">
                    ...
                    <div className="card-body">
                      <h4 className="card-title text-danger fw-bold mt-3">Containted Objects
                    </h4>
                      <p className="card-text py-3">Use the tissue while sneezing,In this way, you can protect your droplets.
                    </p>
                    </div>
                    <div className="">
                        <button className="btn btn-danger w-100">Learn more</button>
        ...
        <section className="container text-center extra-margin-top" id="Symptons">
            <div>
                <h4 className="h3-color">Covid-19
                </h4>
                <h2 className="h1-color mb-lg-5">Symptomps
                </h2>
        ...
        <section className="container my-5 " id="Prevension">
            <h4 className="h3-color text-center">Covid-19
            </h4>
            <h2 className="h1-color text-center mb-lg-5">What should we do
            </h2>
            <p className="text-center">Corona viruses are a type of virus. There are many different kinds, and some cause disease. A newly identified type
            </p>
           <div className="row d-flex my-5 align-items-center">
               <div className="col-12 col-lg-6">
                 <h2 className="h2-color my-3"> <span className="pc">01</span> Wear Masks</h2>
            ...
            <div className="row d-flex my-lg-4 align-items-center">
               ...
               <div className="col-12 col-lg-6">
                 <h2 className="h2-color my-3"><span className="pc">02</span> Wash Your Hands
                </h2>
                 <p>Continually seize impactful vortals rather than future-proof supply chains. Uniquely exploit emerging niches via fully tested meta-services. Competently pursue standards compliant leadership skills vis-a-vis pandemic "outside the box" thinking. Objectively</p>
               </div>
            ...
            <div className="row d-flex my-lg-4 align-items-center">
                <div className="col-12 col-lg-6">
                  <h2 className="h2-color my-3"><span className="pc">03</span> Use nose - rag
                </h2>
                  <p>Continually seize impactful vortals rather than future-proof supply chains. Uniquely exploit emerging niches via fully tested meta-services. Competently pursue standards compliant leadership skills vis-a-vis pandemic "outside the box" thinking. Objectively</p>
                </div>
            ...
            <div className="row d-flex my-lg-4 align-items-center">
               ...
               <div className="col-12 col-lg-6">
                 <h2 className="h2-color my-3"><span className="pc">04</span> Avoid contacts
                </h2>
                 <p>Continually seize impactful vortals rather than future-proof supply chains. Uniquely exploit emerging niches via fully tested meta-services. Competently pursue standards compliant leadership skills vis-a-vis pandemic "outside the box" thinking. Objectively</p>
               </div>
        ...
        <section className="container">
            <div>
                <img className="img-fluid" src={p11} alt=""/>
            </div>
        </section>
