      ...
      <div class="row row-cols-1 row-cols-md-3 g-4 container mx-auto my-5">
        <div class="col ">
          <div class="card h-100 border-0 shadow-lg">
            <img className="p-md-5" src="https://cdn-icons-png.flaticon.com/512/6192/6192088.png"  alt="..." />
            <div class="card-body">
            ...
            <div class="p-1 border">
              ...
              <div class="col">
                  <div class="card h-100 border-0 shadow-lg">
          <img  src="https://cdn-icons-png.flaticon.com/512/6192/6192088.png" className="p-md-5" alt="..." />
          <div class="card-body">
          <h3 class="card-title my-3">Fiver</h3>
            <p class="card-text">
              This is a wider card with supporting text below as a natural
